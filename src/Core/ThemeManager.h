...
class ThemeManager : public QObject
{
    ...
    // The single system-wide easing curve ("confident glide"), Section 3.6.
    // Exposed as a QVariantList so QML can bind it directly:
    //   Behavior on x { NumberAnimation { easing.type: Easing.BezierSpline; easing.bezierCurve: ThemeManager.easingCurve } }
    Q_PROPERTY(QVariantList easingCurve READ easingCurve CONSTANT)
...
public:
    ...
    QVariantList easingCurve() const { return {0.16, 1.0, 0.3, 1.0, 1.0, 1.0}; }
